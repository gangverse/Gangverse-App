...
import CollectionPageRouter from 'views/NftGangverse/market/Collection/CollectionPageRouter'
import { useRouter } from 'next/router'

import PageLoader from 'components/Loader/PageLoader'
import { getCollection } from 'state/nftMarketGangverse/helpers'
import { API_NFT } from 'config/constants/endpoints'
import Minting from 'views/NftGangverse/market/Collection/Minting/Minting'
