...
import {
  ...
  SerializedNftFarmGangverseConfig,
  DeserializedNftFarmConfig,
  DeserializedNftFarmGangverseConfig,
} from 'config/constants/types'
import { NftToken, State as NftMarketState } from './nftMarketGangverse/types'
...
interface SerializedNftFarmGangverseUserData {
  allowance: boolean[]
  tokenBalance: string
  stakedBalance: string
  earnings: string
...
// Types for NFT Stake
export interface DeserializedNftFarmGangverseUserData {
  allowance: boolean[]
  tokenBalance: BigNumber
  stakedBalance: BigNumber
  earnings: BigNumber
...
// Types for NFT Stake
export interface SerializedNftFarmGangverse extends SerializedNftFarmGangverseConfig {
  tokenPriceBusd?: string
  quoteTokenPriceBusd?: string
  tokenAmountTotal?: SerializedBigNumber
  lpTotalInQuoteToken?: SerializedBigNumber
  ...
  stakingLimit?: string
  sideRewards?: any
  userData?: SerializedNftFarmGangverseUserData
}
...
// Types for NFT Stake
export interface DeserializedNftFarmGangverse extends DeserializedNftFarmGangverseConfig {
  tokenPriceBusd?: string
  quoteTokenPriceBusd?: string
  tokenAmountTotal?: BigNumber
  lpTotalInQuoteToken?: BigNumber
  ...
  stakingLimit?: BigNumber
  sideRewards?: any
  userData?: DeserializedNftFarmGangverseUserData
}
...
export interface SerializedNftFarmsGangverseState {
  data: SerializedNftFarmGangverse[]
  loadArchivedFarmsData: boolean
  userDataLoaded: boolean
  loadingKeys: Record<string, boolean>
  poolLength?: number
...
export interface DeserializedNftFarmsGangverseState {
  data: DeserializedNftFarmGangverse[]
  loadArchivedFarmsData: boolean
  userDataLoaded: boolean
  poolLength?: number
}
...
export interface State {
  nftFarmsGangverse: SerializedNftFarmsGangverseState
