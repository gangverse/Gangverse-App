...
import multicall, { multicallCronosv1, multicallCronosv2, multicallv2 } from 'utils/multicall'
...
export const fetchPoolsTotalStaking = async () => {
  const poolsTotalStaked = await multicallCronosv1(erc20ABI, poolsBalanceOf)
