...
import { fetchFarmUserDataAsync } from 'state/nftFarmsGangverse'
import { useFarmUser, useLpTokenPrice, usePriceCakeBusd } from 'state/nftFarmsGangverse/hooks'
import styled from 'styled-components'
import { getAddress } from 'utils/addressHelpers'
import { NftFarmGangverseWithStakedValue } from 'views/NftFarmsGangverse/components/FarmCard/FarmCard'
import useApproveNftFarmGangverse from '../../../hooks/useApproveFarm'
...
import CollectionSelectModal from 'components/CollectionSelectModalGangverse/CollectionSelectModal'

const IconButtonWrapper = styled.div`
  display: flex;
`

interface StackedActionProps extends NftFarmGangverseWithStakedValue {
...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const alternativeCollectionPool = collectionOption ?? 0 > 0 ? nftFarmsGangverseConfig.find(farm => farm.pid === collectionOption) : null
  ...
  const { onApprove } = useApproveNftFarmGangverse(nftContract, smartNftPoolAddress)
