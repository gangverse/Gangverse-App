...
import { getLinbingPoolAddress } from 'utils/addressHelpers'
...
const collectPoolAddress = getLinbingPoolAddress()
...
const CakeDataRow = () => {
  ...
  useSlowRefreshEffect(() => {
    const fetchTokenData = async () => {
      const totalSupplyCall = { address: tokens.linbing.address, name: 'totalSupply' }
      const burnedTokenCall = {
        address: tokens.linbing.address,
        name: 'balanceOf',
      ...
      const tokenDataResultRaw = await multicallCronosv2(cakeAbi, [totalSupplyCall, burnedTokenCall, tvlTokenCall], {
