  ...
  const CardRender = () => {
    ...
    if (collections) {
      ...
      return (<Grid gridGap="16px" gridTemplateColumns={['1fr', '1fr', 'repeat(2, 1fr)', 'repeat(3, 1fr)']} mb="64px">
        ...
        <CollectionCard
          key="dummy"
          bgSrc="/images/collections/banner/darkside.png"
          avatarSrc="/images/collections/logo/darkside.png"
          collectionName="Gangverse Darkside"
          url="https://minted.network/collections/cronos/0xc376d7a55a3fb6fa0b12d90fd96fefb0d96702bf"
        >
          <Flex alignItems="center">
            <Text fontSize="12px" color="textSubtle">
              Volume
        ...
        <CollectionCard
          key="dummy"
          bgSrc="/images/collections/banner/gangverse.png"
          avatarSrc="/images/collections/logo/gangverse.png"
          collectionName="Gangverse Social Club"
          url="https://minted.network/collections/cronos/0xabaa122b9e6b64fcbdd55a03eeb8729220f9c589"
        >
          <Flex alignItems="center">
            <Text fontSize="12px" color="textSubtle">
              Volume
            </Text>
            <BNBAmountLabel amount={8888} />
          </Flex>
        </CollectionCard>
