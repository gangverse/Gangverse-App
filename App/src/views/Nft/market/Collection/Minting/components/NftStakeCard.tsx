...
import nftFarmsConfig from 'config/constants/nftFarmsGangverse'
...
const NftStakeCardBody = ({ farm, account }) => {
  ...
  const isPromotedFarm = true //farm.token.symbol === 'CRO' Caution: Fix
              ...
              {sideRewards.length === 0 ? (
                <Flex justifyContent="space-between" alignItems="center">
                  ...
                  <Text bold style={{ display: 'flex', alignItems: 'center' }}>
                    {getDisplayApr(cakeRewardsApr*31)}%
                  </Text>
                </Flex>
              ) : (
                <>
