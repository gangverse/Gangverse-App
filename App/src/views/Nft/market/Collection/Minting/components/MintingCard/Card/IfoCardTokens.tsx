      ...
      return (
        <>
          ...
          {(account && !isHolder && version == 3.1) && (
            ...
            {`You don't have any Gangverse NFT, NFT holders get %${holderDiscountPercentage} discount and doesn't have to wait for the countdown.`}
              </MessageText>{' '}
              <MessageTextLink display="inline" fontWeight={700} href="https://gangverse.club" target="_blank" color="failure">
                {t('Not too late')} »
              </MessageTextLink>
            </Box>
          </Message>
