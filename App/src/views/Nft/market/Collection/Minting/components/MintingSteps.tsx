...
const Step2 = ({ hasProfile, isLive, isCommitted }: { hasProfile: boolean; isLive: boolean; isCommitted: boolean }) => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('If you own a Gangverse NFT, you are eligible to receive a discount. If you do not have Gangverse NFT, you can buy it now.')} <br />
      </Text>
        <Button external={true} as="a" href="/nfts/collections" mt="16px">
          {t('Buy Now')}
        </Button>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need some CRO for minting NFTs')}
            </Text>
            {/*renderAccountStatus()*/}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Button external={true} as="a" href="/partner-nft-staking" mt="16px">
              {'Stake NFT'}
            </Button>
          </CardBody>
        )
