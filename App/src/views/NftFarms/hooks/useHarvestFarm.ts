...
import { useLinbingNftStake, useSmartNftStakeContract } from 'hooks/useContract'
...
const useHarvestFarm = (farmPid: number) => {
  ...
  const masterChefContract = isSmartNftPool ? useSmartNftStakeContract(farmPid) : useLinbingNftStake() 
