...
import { Collection } from 'state/nftMarketGangverse/types'
import { useGetCollections, useGetNftActivityFilters } from 'state/nftMarketGangverse/hooks'
import {
  addActivityCollectionFilters,
  removeActivityCollectionFilters,
  removeAllActivityCollectionFilters,
} from 'state/nftMarketGangverse/reducer'
