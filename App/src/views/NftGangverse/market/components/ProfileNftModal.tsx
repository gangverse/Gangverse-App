...
const ProfileNftModal: React.FC<ProfileNftModalProps> = ({ nft, onDismiss, onSuccess }) => {
  ...
  return (
    <StyledModal title={t('Details')} onDismiss={onDismiss} headerBackground="#151c21">
      <Flex flexDirection="column" maxWidth="350px">
        ...
        <Flex justifyContent="space-between" px="16px" mb="16px">
          ...
          <Flex justifyContent="space-between" flex="3">
            ...
            <HorizontalDivider />
            <LinkExternal p="0px" height="16px" href={getCronosScanLinkForNft(nft.collectionAddress, nft.tokenId)}>
              CronosScan
            </LinkExternal>
          </Flex>
        </Flex>
