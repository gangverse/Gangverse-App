...
import { BSC_BLOCK_TIME, CRONOS_BLOCK_TIME } from 'config'
import ifoV2Abi from 'config/abi/ifoV2.json'
import gangverseAbi from 'config/abi/GangverseDarksideNFT.json'
      ...
      const [
        ...
        [
          ...
          },
          {
            address,
            name: 'balanceOf',
            params: [account ? account : '0x29bF67C633e54e2277Ee786C740622e6Dea9DB70']
          },
          version === 3.1 && {
            address,
