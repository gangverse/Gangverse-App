...
import { WalletIfoData } from 'views/NftGangverse/market/Collection/Minting/types'
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Button external={true} as="a" href="/gangverse-nft-staking" mt="16px">
              {t('Stake NFT')}
            </Button>
          </CardBody>
        )
