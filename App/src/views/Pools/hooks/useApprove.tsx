...
import { useCake, useLinbing, useSousChef, useVaultPoolContract } from 'hooks/useContract'
...
export const useVaultApprove = (vaultKey: VaultKey, setLastUpdated: () => void) => {
  ...
  return useCakeApprove(
    ...
    t('You can now stake in the %symbol% vault!', { symbol: 'LINBING' }),
  )
}
