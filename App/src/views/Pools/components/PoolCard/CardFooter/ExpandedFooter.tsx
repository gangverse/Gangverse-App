...
import { BASE_CRONOS_SCAN_URL } from 'config'
  ...
  return (
    <ExpandedWrapper flexDirection="column">
        ...
        <Flex mb="2px" justifyContent="space-between" alignItems="center">
          ...
          {blocksRemaining || blocksUntilStart ? (
            <Flex alignItems="center">
              <Link external href={getCronosScanLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
      ...
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal href={`https://app.linbing.biz/#/tokens/cronos/${earningToken.address}`} bold={false} small>
          {t('See Token Info')}
        </LinkExternal>
      </Flex>
      }
      ...
      {poolContractAddress && (
        <Flex mb="2px" justifyContent="flex-end">
          <LinkExternal
            href={`${BASE_CRONOS_SCAN_URL}/address/${vaultKey ? cakeVaultContractAddress : poolContractAddress}`}
            bold={false}
            small
          >
            {t('View Contract')}
