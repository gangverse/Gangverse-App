...
import { useLinbingAutoPoolVaultContract } from 'hooks/useContract'
...
const BountyModal: React.FC<BountyModalProps> = ({
  ...
  const cakeVaultContract = useLinbingAutoPoolVaultContract()
  ...
  return (
    <Modal title={t('Claim Bounty')} onDismiss={onDismiss} headerBackground={theme.colors.gradients.cardHeader2}>
      ...
      <Flex alignItems="flex-start" justifyContent="space-between">
        ...
        <Flex flexDirection="column">
          <Balance bold value={cakeBountyToDisplay} decimals={7} unit=" LINBING" />
      ...
      <Flex alignItems="center" justifyContent="space-between">
        ...
        <Balance color="textSubtle" value={totalYieldToDisplay} unit=" LINBING" />
      </Flex>
