      ...
      <InfoSection>
        ...
        {shouldShowBlockCountdown && blocksRow}
        {
          <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
            <LinkExternal href={`https://app.linbing.biz/#/tokens/cronos/${earningToken.address}`} bold={false}>
              {t('See Token Info')}
            </LinkExternal>
          </Flex>
        }
        ...
        {poolContractAddress && (
          <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
            <LinkExternal
              href={`${BASE_CRONOS_SCAN_URL}/address/${vaultKey ? vaultContractAddress : poolContractAddress}`}
              bold={false}
            >
              {t('View Contract')}
            </LinkExternal>
