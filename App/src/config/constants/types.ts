...
interface NftFarmGangverseConfigBaseProps {
  pid: number
  lpSymbol: string
  nftAddresses: Address
  contractAddresses?: Address
...
export interface SerializedNftFarmGangverseConfig extends NftFarmGangverseConfigBaseProps {
  earningToken?: SerializedToken
  projectLink?: string
}
...
// New type for NFT Stake config
export interface DeserializedNftFarmGangverseConfig extends NftFarmGangverseConfigBaseProps {
  earningToken: Token
}
