...
function collectionKey(collection: DeserializedNftFarmGangverse): number {
...
function CollectionRow({
  ...
  collection: DeserializedNftFarmGangverse
  ...
  const nftFarmGangverseData = nftFarmsGangverseConfig.find((nftFarmGangverse) => nftFarmGangverse.pid === collection.pid)
...
export default function CollectionList({
  ...
  height: number
  collections: DeserializedNftFarmGangverse[]
  ...
  const Row = useCallback(
    ({ data, index, style }) => {
      const collection: DeserializedNftFarmGangverse = data[index]
