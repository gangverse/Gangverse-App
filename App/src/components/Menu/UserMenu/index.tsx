...
import { useGetBnbBalance, useGetCroBalance } from 'hooks/useTokenBalance'
...
const UserMenu = () => {
  ...
  const hasLowCroBalance = fetchStatus === FetchStatus.Fetched && balance.lte(LOW_CRO_BALANCE)
  ...
  const UserMenuItems = () => {
    return (
      <>
        <WalletUserMenuItem
          hasLowCroBalance={hasLowCroBalance}
